namespace LFramework
{
    ...
    public delegate TResult LFrameworkFunc<out TResult>();
    ...
    /// <returns>此委托封装的方法的返回值。</returns>
    public delegate TResult LFrameworkFunc<in T, out TResult>(T arg);
    ...
    /// <returns>此委托封装的方法的返回值。</returns>
    public delegate TResult LFrameworkFunc<in T1, in T2, out TResult>(T1 arg1, T2 arg2);
    ...
    /// <returns>此委托封装的方法的返回值。</returns>
    public delegate TResult LFrameworkFunc<in T1, in T2, in T3, out TResult>(T1 arg1, T2 arg2, T3 arg3);
    ...
    /// <returns>此委托封装的方法的返回值。</returns>
    public delegate TResult LFrameworkFunc<in T1, in T2, in T3, in T4, out TResult>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
