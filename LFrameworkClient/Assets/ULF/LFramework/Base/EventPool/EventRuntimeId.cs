...
namespace LFramework
{
    ...
    public static class EventRuntimeId
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, int> EventString2RuntimeDict = new Dictionary<string, int>();

        /// <summary>
        /// Key->RuntimeId    | Value->字符串 (Table)
        /// </summary>
        private static readonly Dictionary<int, string> EventRuntimeToStringDict = new Dictionary<int, string>();
        ...
        {
            if (EventString2RuntimeDict.TryGetValue(value, out var runtimeId))
            {
                return runtimeId;
            }

            runtimeId = ++_currentRuntimeId;
            EventString2RuntimeDict[value] = runtimeId;
            EventRuntimeToStringDict[runtimeId] = value;
        ...
        {
            return EventRuntimeToStringDict.TryGetValue(runtimeId, out var value) ? value : string.Empty;
        }
    }
}