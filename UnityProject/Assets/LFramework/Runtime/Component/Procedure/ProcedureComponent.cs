    ...
    public sealed class ProcedureComponent : MonoBehaviour, ILFrameworkModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                ...
                {
                    throw new LFrameworkException("You must initialize procedure first.");
                }
        ...
        private IEnumerator Start()
        {
            ...
            Initialize(LFrameworkEntry.GetModule<IFsmManager>(), procedures);

            yield return new WaitForEndOfFrame();

            StartProcedure(_entranceProcedure.GetType());
        }
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            if (fsmManager == null)
            {
                throw new LFrameworkException("FSM manager is invalid.");
            }
