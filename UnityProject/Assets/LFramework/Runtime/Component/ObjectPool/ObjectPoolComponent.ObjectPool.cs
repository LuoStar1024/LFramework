...
namespace LFramework
{
    public sealed partial class ObjectPoolComponent
    {
        ...
        {
            private readonly LFrameworkMultiDictionary<string, Object<T>> _objects;
            ...
            public ObjectPool(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity,
                ...
                : base(name)
            {
                _objects = new LFrameworkMultiDictionary<string, Object<T>>();
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, LFrameworkLinkedListRange<Object<T>>> objectRanges in _objects)
                {
