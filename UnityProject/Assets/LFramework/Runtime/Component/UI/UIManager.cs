...
namespace LFramework
{
    ...
    /// 界面管理器。
    /// </summary>
    internal sealed partial class UIManager : MonoBehaviour, ILFrameworkModule, IUIManager
    {
        ...
        public bool AddUIGroup(string uiGroupName, int uiGroupDepth, IUIGroupHelper uiGroupHelper)
        {
            ...
            {
                throw new LFrameworkException("UI group helper is invalid.");
            }
            ...
            object userData)
        {
            ...
            {
                throw new LFrameworkException("You must set UI form helper first.");
            }
