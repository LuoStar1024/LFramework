...
namespace LFramework.Editor
{
    ...
    internal sealed class ProcedureComponentInspector : LFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                if (_currentAvailableProcedureTypeNames.Count > 0)
                {
                    ...
                    int selectedIndex = EditorGUILayout.Popup("Entrance Procedure", _entranceProcedureIndex,
        ...
        private void ReadAvailableProcedureTypeNames()
        {
            ...
            {
                _currentAvailableProcedureTypeNames.Add(_availableProcedureTypeNames.GetArrayElementAtIndex(i)
                    .stringValue);
            }
        }
