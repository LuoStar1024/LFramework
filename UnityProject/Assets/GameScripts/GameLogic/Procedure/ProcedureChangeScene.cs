...
namespace GameLogic
{
    ...
    public class ProcedureChangeScene : ProcedureBase
    {
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            GameEntry.Scene.LoadScene(AssetUtility.GetSceneAsset(_changeToSceneName), OnLoadSceneProgress,
                OnLoadSceneSuccess);
        ...
        {
            _loadingId = await GameEntry.UI.OpenUIFormAwait(AssetUtility.GetUIFormAsset("LoadingForm"),
                Constant.Setting.UIGroupTop,
                10, false, null);
