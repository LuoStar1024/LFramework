...
namespace GameLogic
{
    ...
    {
        private readonly LFrameworkMultiDictionary<int, EventHandler<GameEventArgs>> _eventHandlerDict = new LFrameworkMultiDictionary<int, EventHandler<GameEventArgs>>();
